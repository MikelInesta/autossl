...
CREATE TABLE server (
    ...
    UNIQUE KEY unique_server_user (server_name, user_id)
) CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE server
    ADD CONSTRAINT server_ibfk_1 FOREIGN KEY (user_id) REFERENCES `users` (user_id) ON DELETE CASCADE ON UPDATE CASCADE;
